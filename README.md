...
개발자 취업 준비생의 **GitHub 프로젝트를 코드 수준까지 분석**하고, 이를 근거로 기존 포트폴리오를 **개선**하거나 새 포트폴리오의 **방향을 설계**해주는 서비스입니다. 본 레포지토리는 해당 서비스의 **Frontend(Web SPA)** 를 담당합니다.
...
- **서비스** : https://www.passfolio.dev
- **발표 자료 (Web PPT)** : https://www.passfolio.dev/docs/passfolio-deck

---

# Team Introduction

## PART Members — Frontend
...
- **서비스 점검 모드** : 환경변수 플래그로 API 의존 라우트를 점검 안내 페이지로 일괄 전환

## Environment

- **Frontend** :
  ![React](https://img.shields.io/badge/React%2019-61DAFB?style=flat&logo=react&logoColor=black)
  ![TypeScript](https://img.shields.io/badge/TypeScript%205.9-3178C6?style=flat&logo=typescript&logoColor=white)
  ![Vite](https://img.shields.io/badge/Vite%207-646CFF?style=flat&logo=vite&logoColor=white)
  ![TailwindCSS](https://img.shields.io/badge/TailwindCSS%204-06B6D4?style=flat&logo=tailwindcss&logoColor=white)
  ![React Router](https://img.shields.io/badge/React%20Router%207-CA4245?style=flat&logo=reactrouter&logoColor=white)
  ![Axios](https://img.shields.io/badge/Axios-5A29E4?style=flat&logo=axios&logoColor=white)
  ![Tiptap](https://img.shields.io/badge/Tiptap-000000?style=flat)
  ![React Flow](https://img.shields.io/badge/React%20Flow-1A192B?style=flat)
  ![SSE](https://img.shields.io/badge/SSE%20·%20EventSource-4B5563?style=flat)
...
- **Infra** :
  ![Cloudflare](https://img.shields.io/badge/Cloudflare%20DNS%20·%20WAF%20·%20CDN-F38020?style=flat&logo=cloudflare&logoColor=white)
  ![AWS S3](https://img.shields.io/badge/AWS%20S3-569A31?style=flat&logo=amazons3&logoColor=white)

## Docs

- **서비스 Documentation** : [passfolio.dev/docs](https://www.passfolio.dev/docs)
- **발표 자료 (Web PPT, 17p)** : [Passfolio Deck](https://www.passfolio.dev/docs/passfolio-deck) — 서비스 배경·아키텍처·워크플로·성과 정리
...
> ◦ 풀스택 1인 · 프론트엔드 1인 · 백엔드 1인 · 포트폴리오 AI 1인 구성으로, 4개 파트(Frontend · Backend · Portfolio-AI · Project-Analyzer-AI)를 나누어 협업했습니다.<br>
