...
export const PRIVACY_SECTION_LIST: PrivacySectionType[] = [
  {
    ...
    title: '제1조(목적)',
    paragraphs: [
      'Passfolio(이하 ‘회사’라고 합니다)는 회사가 제공하는 개발자 맞춤 포트폴리오 생성, GitHub 연동 기반 프로젝트·기여 분석, 채용 공고(JD) 기반 기능 등 온라인 서비스(이하 ‘회사 서비스’)를 이용하는 개인(이하 ‘이용자’ 또는 ‘개인’)의 정보(이하 ‘개인정보’)를 보호하기 위해, 「개인정보 보호법」, 「정보통신망 이용촉진 및 정보보호 등에 관한 법률」(이하 ‘정보통신망법’) 등 관련 법령을 준수하고, 서비스 이용자의 개인정보 보호 관련 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보처리방침(이하 ‘본 방침’)을 수립합니다.',
    ],
  },
  {
    id: 'art2',
  ...
  },
  {
    ...
    title: '제3조(본 방침의 공개)',
    paragraphs: [
      '회사는 이용자가 언제든지 쉽게 본 방침을 확인할 수 있도록 Passfolio 웹사이트 첫 화면 또는 첫 화면과의 연결화면을 통해 본 방침을 공개하고 있습니다.',
  ...
  {
    id: 'art5',
    title: '제5조(회원 가입 및 로그인을 위한 정보)',
    paragraphs: [
      '회사는 이용자의 회사 서비스 회원가입·로그인을 위하여 다음과 같은 정보를 수집할 수 있습니다.',
      '필수 수집 정보: GitHub OAuth 연동을 통해 제공되는 계정 식별자, 이메일 주소, 이름(또는 공개 프로필상 표시명) 등 이용자가 GitHub에 등록한 정보로서 회사가 접근·수신하는 범위 내의 정보',
    ],
  },
  {
    id: 'art6',
    title: '제6조(본인 확인을 위한 정보)',
    paragraphs: [
      '회사는 GitHub 계정 연동을 통한 본인 확인 및 계정 도용 방지를 위하여 제5조에 기재된 정보 및 GitHub가 제공하는 인증·프로필 정보를 이용할 수 있습니다.',
    ],
  },
  {
    id: 'art7',
    title: '제7조(회사 서비스 제공을 위한 정보)',
    paragraphs: [
      '회사는 이용자에게 회사 서비스(포트폴리오 생성·편집·저장, GitHub 저장소·기여 분석, 채용 공고 기반 맞춤 기능 등)를 제공하기 위하여 다음과 같은 정보를 수집·이용할 수 있습니다.',
      '필수 수집 정보: 계정 식별에 필요한 정보(로그인 식별자·이메일 등), GitHub 연동을 통해 수집되는 공개 프로필 및 이용자 동의·GitHub 설정 범위 내의 저장소·기여 관련 메타데이터, 서비스 이용 과정에서 생성되는 로그·이용 기록 등',
      '선택 정보: 이용자가 프로필 등에 직접 입력하는 학력·경력·기술 스택 등 부가 정보(입력 시 수집·이용)',
    ],
  },
  {
    id: 'art8',
    ...
    paragraphs: [
      ...
      '① 이용자가 Passfolio 웹사이트 또는 애플리케이션에 자신의 개인정보를 입력하는 방식',
      '② GitHub 등 외부 플랫폼 OAuth 연동을 통해 이용자가 동의한 범위에서 정보를 수집하는 방식',
      '③ 서비스 이용 과정에서 자동으로 생성·수집될 수 있는 정보(접속 로그, 쿠키 등 관련 법령이 허용하는 범위)',
    ],
  },
  {
    id: 'art9',
    ...
    paragraphs: [
      ...
      '② 이용문의에 대한 회신, 불만 처리 등 이용자에 대한 서비스 개선을 위한 경우',
      '③ 회사의 서비스(포트폴리오·분석·GitHub 연동 기능 등)를 제공하기 위한 경우',
      '④ 법령 및 회사 약관을 위반하는 회원에 대한 이용 제한 조치, 부정 이용 행위를 포함하여 서비스의 원활한 운영에 지장을 주는 행위에 대한 방지 및 제재를 위한 경우',
      '⑤ 개인정보 및 관심에 기반한 이용자 간 관계 형성을 위한 경우(해당 기능을 제공하는 경우)',
    ],
  },
  {
    id: 'art10',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      '「전자상거래 등에서의 소비자보호에 관한 법률」에 따른 보유정보 및 보유기간',
      '· 계약 또는 청약철회 등에 관한 기록 : 5년',
      '· 대금결제 및 재화 등의 공급에 관한 기록 : 5년',
      '· 소비자의 불만 또는 분쟁처리에 관한 기록 : 3년',
      '· 표시·광고에 관한 기록 : 6개월',
      '「통신비밀보호법」에 따른 보유정보 및 보유기간',
      '· 웹사이트 로그 기록 자료 : 3개월',
      '「전자금융거래법」에 따른 보유정보 및 보유기간',
      '· 전자금융거래에 관한 기록 : 5년',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      '회사는 민감한 개인정보를 수집 및 보유하고 있는 경우 암호화 통신 등을 통하여 네트워크상에서 개인정보를 안전하게 전송할 수 있도록 하고 있습니다.',
    ],
  },
  {
    id: 'art24',
  ...
  },
  {
    ...
    paragraphs: [
      '회사는 개인정보의 분실·도난·유출(이하 "유출 등"이라 합니다) 사실을 안 때에는 지체 없이 다음 각 호의 모든 사항을 해당 이용자에게 알리고 방송통신위원회 또는 한국인터넷진흥원에 신고합니다.',
      '① 유출 등이 된 개인정보 항목',
      '② 유출 등이 발생한 시점',
      '③ 이용자가 취할 수 있는 조치',
  ...
  {
    id: 'art27',
    title: '제27조(개인정보 자동 수집 장치의 설치·운영 및 거부에 관한 사항)',
    paragraphs: [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      '회사는 정보주체의 개인정보자기결정권을 보장하고, 개인정보침해로 인한 상담 및 피해 구제를 위해 노력하고 있으며, 신고나 상담이 필요한 경우 제1항의 담당부서로 연락해 주시기 바랍니다.',
  ...
  },
  {
    id: 'supplementary',
    title: '부칙',
    paragraphs: ['제1조 본 방침은 2026년 06월 04일부터 시행됩니다.'],
  },
];
